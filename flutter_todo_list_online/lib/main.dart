...
class TodoListState extends State<TodoList> {
  ...
  Widget todoItemContainer(BuildContext context, Todo todo) {
    return Dismissible(
      key: UniqueKey(),
      child: todoItem(context, todo),
    ...
    return ListTile(
      title: TextButton(
        style: TextButton.styleFrom(
          foregroundColor: todo.isCompleted ? Colors.green : Colors.black,
          backgroundColor:
              _todoSelectedId == todo.id ? Colors.lightBlueAccent : null,
            ...
            child: _todos.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int i) {
                      ...
                      return todoItemContainer(context, todo);
                    },
                  ),
          ),
